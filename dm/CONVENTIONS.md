...
- **Каждый тик — отдельная секция с заголовком** (## Тик N)
- Не группировать тики в абзацы типа "тик 1–4"
...
├── story_log.md        # фактический лог на русском (речь, интенты, события)
├── summary.md          # выводы с перспективы СИМУЛЯТОРА на русском
├── turn_log.jsonl     # полный лог тиков (dm_query + player_response)
